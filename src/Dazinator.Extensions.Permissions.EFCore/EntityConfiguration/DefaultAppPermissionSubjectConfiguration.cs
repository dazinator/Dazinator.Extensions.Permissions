...
{
    public abstract class DefaultAppPermissionSubjectConfiguration<TAppPermissionSubject,TAppPermissionType, TAppPermission> : IEntityTypeConfiguration<TAppPermissionSubject>
