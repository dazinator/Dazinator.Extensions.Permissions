...
{
    public class DefaultAppPermissionSubjectConfiguration<TAppPermissionSubject,TAppPermissionType, TAppPermission> : IEntityTypeConfiguration<TAppPermissionSubject>
