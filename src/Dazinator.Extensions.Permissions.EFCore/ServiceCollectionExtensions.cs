...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {      
        ...
        {
            builder.AddPermissionService<DbContextPermissionService<TDbContext, TApp, TAppPermission, TAppPermissionSubject, TAppPermissionType>>();
            return builder;
        }


        /// <summary>
        /// Adds an <see cref="IPermissionService{TApp, TAppPermission, TAppPermissionSubject, TAppPermissionType}"/> backed by a DbContext using a standard set of default entities. Don't use this if you need to customise the entities. 
        /// </summary>
        /// <typeparam name="TDbContext"></typeparam>
        /// <param name="builder"></param>
        /// <returns></returns>
        public static PermissionsRegistrationBuilder<DefaultAppPermission, DefaultAppPermissionType, DefaultAppPermissionSubject, DefaultApp> AddDbContextDefaultPermissionService<TDbContext>(this PermissionsRegistrationBuilder<DefaultAppPermission, DefaultAppPermissionType, DefaultAppPermissionSubject, DefaultApp> builder)
           where TDbContext : DbContext
        {
            builder.AddPermissionService<DefaultDbContextPermissionService<TDbContext>>();
            return builder;
        }
